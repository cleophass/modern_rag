...
class Setup:
    ...
    def verify_setup(self) -> bool:
        try:
            ...
            if self.activity_logger.es_client.verify_index(
                    self.activity_logger.logger_index_name):
        ...
        try:
            ...
            if len(raw_fnames) != len(clean_fnames):
                ...
                if doc_manager.es_client.verify_index(
            ...
            self.activity_logger.log_interaction(
                f"documents processing error : {e}", "error")
            return False
